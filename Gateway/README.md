...
To build the final jar and optimize the MentorOnDemandV2 application for production, run:
...
Then navigate to [http://localhost:9087](http://localhost:9087) in your browser.
