...
import { IPaymentRecord, PaymentRecord } from 'app/shared/model/payments/payment-record.model';
...
describe('Service Tests', () => {
  describe('PaymentRecord Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new PaymentRecord(0, PayTraType.PAID, 0, 0, currentDate, 0, 'AAAAAAA');
    });
