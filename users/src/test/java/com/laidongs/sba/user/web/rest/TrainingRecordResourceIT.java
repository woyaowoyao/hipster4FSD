...
import com.laidongs.sba.user.UsersApp;
import com.laidongs.sba.user.config.SecurityBeanOverrideConfiguration;
import com.laidongs.sba.user.domain.TrainingRecord;
import com.laidongs.sba.user.repository.TrainingRecordRepository;
import com.laidongs.sba.user.service.TrainingRecordService;
...
import static com.laidongs.sba.user.web.rest.TestUtil.createFormattingConversionService;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.laidongs.sba.user.domain.enumeration.TrainRecordStatus;
import com.laidongs.sba.user.domain.enumeration.ProgressType;
/**
