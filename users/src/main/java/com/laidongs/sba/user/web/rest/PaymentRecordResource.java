...
import com.laidongs.sba.user.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.laidongs.sba.user.domain.PaymentRecord}.
 */
@RestController
@RequestMapping("/api")
public class PaymentRecordResource {
    ...
    public List<PaymentRecord> getAllPaymentRecords() {
        log.debug("REST request to get all PaymentRecords");
