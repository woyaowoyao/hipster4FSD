package com.laidongs.sba.user.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.laidongs.sba.user.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.laidongs.sba.user.repository.UserRepository.USERS_BY_EMAIL_CACHE);
