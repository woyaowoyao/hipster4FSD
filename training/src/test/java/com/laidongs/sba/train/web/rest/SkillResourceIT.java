...
import com.laidongs.sba.train.TrainingApp;
import com.laidongs.sba.train.config.SecurityBeanOverrideConfiguration;
import com.laidongs.sba.train.domain.Skill;
import com.laidongs.sba.train.repository.SkillRepository;
import com.laidongs.sba.train.web.rest.errors.ExceptionTranslator;
...
import static com.laidongs.sba.train.web.rest.TestUtil.createFormattingConversionService;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, TrainingApp.class})
public class SkillResourceIT {
    ...
    public void createSkill() throws Exception {
        ...
        assertThat(testSkill.getToc()).isEqualTo(DEFAULT_TOC);
        assertThat(testSkill.getPreprequisites()).isEqualTo(DEFAULT_PREPREQUISITES);
    }
    ...
    public void updateSkill() throws Exception {
        ...
        assertThat(testSkill.getToc()).isEqualTo(UPDATED_TOC);
        assertThat(testSkill.getPreprequisites()).isEqualTo(UPDATED_PREPREQUISITES);
    }
