...
import { ITechnology, Technology } from 'app/shared/model/trainings/technology.model';
...
describe('Service Tests', () => {
  describe('Technology Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(TechnologyService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Technology(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
