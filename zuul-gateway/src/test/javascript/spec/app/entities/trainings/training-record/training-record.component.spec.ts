...
import { TrainingRecordComponent } from 'app/entities/trainings/training-record/training-record.component';
import { TrainingRecordService } from 'app/entities/trainings/training-record/training-record.service';
...
describe('Component Tests', () => {
  describe('TrainingRecord Management Component', () => {
    let comp: TrainingRecordComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TrainingRecordComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.trainingRecords[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
