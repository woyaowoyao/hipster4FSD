...
import com.laidongs.sba.payment.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.laidongs.sba.payment.domain.PaymentRecord}.
 */
@RestController
@RequestMapping("/api")
public class PaymentRecordResource {
    ...
    private static final String ENTITY_NAME = "paymentPaymentRecord";
