...
export class SkillUpdate extends React.Component<ISkillUpdateProps, ISkillUpdateState> {
  ...
  render() {
    const { skillEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="gatewayApp.skill.home.createOrEditLabel">Create or edit a Skill</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : skillEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="tocLabel" for="skill-toc">
                    Toc
                  </Label>
                  <AvField id="skill-toc" type="text" name="toc" />
                </AvGroup>
                <AvGroup>
                  <Label id="preprequisitesLabel" for="skill-preprequisites">
                    Preprequisites
                  </Label>
                  <AvField id="skill-preprequisites" type="text" name="preprequisites" />
                </AvGroup>
