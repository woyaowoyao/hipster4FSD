...
export class MemberDeleteDialog extends React.Component<IMemberDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.memberEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="gatewayApp.member.delete.question">Are you sure you want to delete this Member?</ModalBody>
        <ModalFooter>
