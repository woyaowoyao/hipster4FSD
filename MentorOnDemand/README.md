...
To build the final jar and optimize the MentorOnDemand application for production, run:
...
Then navigate to [http://localhost:9088](http://localhost:9088) in your browser.
