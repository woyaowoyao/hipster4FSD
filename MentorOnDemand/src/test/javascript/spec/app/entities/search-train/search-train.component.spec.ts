...
import { SearchTrainComponent } from 'app/entities/search-train/search-train.component';
...
describe('Component Tests', () => {
  describe('SearchTrain Management Component', () => {
    let comp: SearchTrainComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SearchTrainComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.searchTrains[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
