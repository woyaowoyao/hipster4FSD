...
import com.laidongs.sba.gateway.config.audit.AuditEventConverter;
import com.laidongs.sba.gateway.domain.PersistentAuditEvent;
...
import static com.laidongs.sba.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
