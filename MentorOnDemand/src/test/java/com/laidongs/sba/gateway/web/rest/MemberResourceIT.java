...
import com.laidongs.sba.gateway.repository.MemberRepository;
...
public class MemberResourceIT {
    ...
    private static final MemberType DEFAULT_TYPE = MemberType.Trainer;
    private static final MemberType UPDATED_TYPE = MemberType.Mentor;
    ...
    public void createMember() throws Exception {
        ...
        assertThat(testMember.getUserName()).isEqualTo(DEFAULT_USER_NAME);
    ...
    public void updateMember() throws Exception {
        ...
        assertThat(testMember.getUserName()).isEqualTo(UPDATED_USER_NAME);
