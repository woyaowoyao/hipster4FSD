package com.laidongs.sba.payment.web.rest;

import com.laidongs.sba.payment.PaymentApp;
import com.laidongs.sba.payment.config.SecurityBeanOverrideConfiguration;
import com.laidongs.sba.payment.domain.PaymentRecord;
import com.laidongs.sba.payment.repository.PaymentRecordRepository;
import com.laidongs.sba.payment.service.PaymentRecordService;
import com.laidongs.sba.payment.web.rest.errors.ExceptionTranslator;
...
import static com.laidongs.sba.payment.web.rest.TestUtil.createFormattingConversionService;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, PaymentApp.class})
